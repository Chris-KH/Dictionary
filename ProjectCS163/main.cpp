...
int main(int argc, char *argv[])
{
    ...
    w.historyWords.push_back(wd);
    w.favouriteWords.push_back(wd);
    wd.name="favourite"; wd.definition="được ưa thích nhất\nngười hoặc vật được yêu thích hơn những người hoặc vật khác";
    w.engEngWords.push_back(wd);
    w.show();
    return a.exec();
}
